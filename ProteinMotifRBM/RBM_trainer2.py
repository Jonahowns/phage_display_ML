...
cout = [dest + 'c1_' + str(i) + '_h.dat' for i in np.arange(10, 260, 50)]
cout_sq = [dest + 'c1_' + str(i) + '_h_w.dat' for i in np.arange(10, 260, 50)]
