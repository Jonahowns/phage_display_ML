...
source_dir = "/scratch/jprocyk/machine_learning/phage_display_ML/cov/trained_rbms/"
# Path from our endpoint since it's mounted at /scratch
source_endpoint_dir = "/jprocyk/machine_learning/phage_display_ML/cov/trained_rbms/"

# local destination on my computer
dest_dir = "/mnt/D1/globus/cov_trained_rbms/"
...
if __name__=='__main__':
    ...
    parser.add_argument('model_string', type=str, nargs="+", help="Which models to transfer, r or r_w")
